...
class RecyclerAdapter(private val itemClick: (Movie) -> Unit) :
    ListAdapter<Movie, RecyclerAdapter.ViewHolder>(
        diffUtil
    ...
    override fun onRowSelected(itemViewHolder: MovieAdapter.ViewHolder?) {
    ...
    override fun onRowClear(itemViewHolder: MovieAdapter.ViewHolder?) {
        Logger.d("onRowClear")
        itemViewHolder!!.rowView!!.setBackgroundColor(
            ContextCompat.getColor(
                itemViewHolder.context!!,
