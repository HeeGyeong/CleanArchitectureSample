...
현재 버전 업데이트 진행 중. 버전 문제로 빌드가 정상적으로 진행되지 않을 수 있습니다.

기존 샘플 프로젝트에서 사용하던 Gradle 및 라이브러리 버전이 최신화 되어있지 않아 실 사용시에 문제가 발생하는 코드가 있습니다.

관련해서 확인 후 수정 및 개선 작업에 있으니, 빌드가 되지 않을 경우 구조만 참고해주세요.
